...
urlpatterns = [
    ...
    path("api/notifications/unread/", views.unread_notifications_api),
    path("remove-favorite/<int:id>/", views.remove_favorite),
    path("notifications/", views.notifications),
    path("api/game/<int:id>/comments/", views.comments_api),
]
